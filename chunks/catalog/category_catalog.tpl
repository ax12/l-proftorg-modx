<section class="pt-120 pb-90 section-pattern bg-img" style="background-image: url(&quot;assets/img/section-pattern/case-study-pattern.png&quot;);">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <!-- Section Title Begin -->
        ...
        <div class="row project-items grid" style="position: relative; height: 1304px;">
            <!-- Single Project Begin -->
            <div class="col-lg-6 grid-item sales business" style="position: absolute; left: 0%; top: 0px;">
            ...
            <!-- Single Project Begin -->
            <div class="col-lg-6 grid-item sales financial" style="position: absolute; left: 50%; top: 0px;">
                <div class="single-project-item">
                    <!-- Project Image Begin -->
                    <div class="image">
            ...
            <!-- Single Project Begin -->
            <div class="col-lg-6 grid-item investment business" style="position: absolute; left: 0%; top: 652px;">
                <div class="single-project-item">
                    <!-- Project Image Begin -->
                    <div class="image">
            ...
            <!-- Single Project Begin -->
            <div class="col-lg-6 grid-item financial funds" style="position: absolute; left: 50%; top: 652px;">
                <div class="single-project-item">
                    <!-- Project Image Begin -->
                    <div class="image">
